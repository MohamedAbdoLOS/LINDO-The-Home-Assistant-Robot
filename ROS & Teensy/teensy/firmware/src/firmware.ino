...
#include "lindo_msgs/Velocities.h"
//header file for cmd_subscribing to "cmd_vel"
#include "geometry_msgs/Twist.h"
//header file for pid server
#include "lindo_msgs/PID.h"
//header file for imu
#include "lindo_msgs/Imu.h"

#include "lindo_base_config.h"
#include "Motor.h"
...
Kinematics kinematics(Kinematics::LINDO_BASE, MAX_RPM, WHEEL_DIAMETER, FR_WHEELS_DISTANCE, LR_WHEELS_DISTANCE, PWM_BITS);
...
void PIDCallback(const lindo_msgs::PID& pid);

ros::NodeHandle nh;

ros::Subscriber<geometry_msgs::Twist> cmd_sub("cmd_vel", commandCallback);
ros::Subscriber<lindo_msgs::PID> pid_sub("pid", PIDCallback);

lindo_msgs::Imu raw_imu_msg;
ros::Publisher raw_imu_pub("raw_imu", &raw_imu_msg);

lindo_msgs::Velocities raw_vel_msg;
...
void setup()
{
    ...
    nh.loginfo("LINDOBASE CONNECTED");
    delay(1);
}
...
void PIDCallback(const lindo_msgs::PID& pid)
{
    //callback function every time PID constants are received from lindo_pid for tuning
